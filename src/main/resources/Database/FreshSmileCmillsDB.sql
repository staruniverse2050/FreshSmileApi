...
CREATE TABLE procedimientos (
  ...
  identificacion_especialistas INT,
  foto BLOB,
  nombre VARCHAR(100),
  descripcion VARCHAR(200),
  costo DECIMAL(10, 3),
  FOREIGN KEY (identificacion_especialistas) REFERENCES especialista(identificacion_especialista)
);
...
CREATE TABLE citas (
  ...
  estado_cita ENUM('Programada', 'Realizada', 'Ausencia', 'Cancelada'),
...
CREATE PROCEDURE crear_cita(
    ...
    IN p_estado_cita ENUM('Programada', 'Realizada', 'Ausencia', 'Cancelada')
)
BEGIN
...
INSERT INTO procedimientos (identificacion_especialistas, nombre, descripcion, costo)
VALUES ( 1106987459, 'Limpieza dental','Procedimiento de limpieza y remoción de placa dental', 50.000);
...
VALUES (123456789, 'Cédula de Ciudadanía', 'Juan Pérez', '2023-06-06', '10:00:00', 1094226206, 1106987459, 1, 'Programada');
...
CALL crear_cita(1094220208, 'Marlin Sanchez', 'Cédula de Ciudadanía', '2023-06-10', '10:00:00', 1094226206, 1106987459, 1, 'Ausencia');
CALL modificar_cita(2, 1094220287, 'Marlin Sanchez', 'Cédula de Ciudadanía', '2023-06-10', '10:00:00', 1094226206, 1106987459, 1, 'Programada');
